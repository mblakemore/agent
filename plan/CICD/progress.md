...
| 0015 | 2026-04-11 | tool-spinner-noninteractive | #34 | (pending) | P-count (tests/ count) | `grep -cE '^  -> \w+ +-> \w+\(' ` on probe log (duplicated tool-start prefixes) | 1 | 0 | −1 (−100%) | PASS | cicd/0015-tool-spinner-noninteractive |
